#!/usr/bin/env bash
#
# start-kde-alt.sh — atalho de compatibilidade.
#
...
#
# Equivalente moderno:  ./lx start --alt
#
# Inicia pelo método alternativo (-xstartup).
#
set -euo pipefail
...
echo "nota: este script agora é só um atalho para './lx start --alt'" >&2
exec "$LX" start --alt "$@"
